...
?>
        <h3>Productos Destacados</h3>
          <div align="center"><br />
            <a href="<?php echo "productos.php?prod_id=".$id; ?>" title="<?php echo $prod_nombre; ?>">
            <img src="<?php echo $url_thumbs_folder_prod.$prod_imagen; ?>" border="0" alt="<?php echo $prod_nombre; ?>" /></a>
            <p><a href="<?php echo "productos.php?prod_id=".$id; ?>" title="<?php echo $prod_nombre; ?>"><?php echo $prod_nombre; ?></a></p>
          </div>
...
?>
        <h3>Servicios Destacados</h3>
          <div align="center"><br />
            ...
            <p><a href="<?php echo "servicios.php?serv_id=".$id; ?>" title="<?php echo $serv_nombre; ?>"><?php echo $serv_nombre; ?></a></p>
          </div>
